...
// SCENE 4 - INHERITANCE
//
// Same hero as scene 3. Notice it only ever talks about `Enemy`.
// It has no idea FlyingEnemy exists, and it can attack one anyway. Hold that thought for scene 5.
